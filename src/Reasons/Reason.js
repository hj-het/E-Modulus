...
const Reasons = () => {
  ...
  return (
    <div className="why-E-modulus-container">
      <div className="content-wrapper">
        <h2 className="main-title">Why E-modulus Is The Best Of The Best?</h2>
        <p className="sub-title">24 reasons to choose E-modulus</p>
        ...
        <div className="reason-description">
          <p>
            E-modulus is the perfect solution for you! Indeed, hundreds of
