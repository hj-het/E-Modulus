    ...
    <div className="privacy_policy">
      ...
      <ul className="points">
        ...
        <li>
          ...
          "Us" or "Our" in this Agreement) refers to Extlikes UK Marketing
          Limited, 1Technique Building, 140 Goswell Road, Unit 3, London EC1V
          7DY, United Kingdom.
        </li>
        <li>
        ...
        <li>
          ...
          website or social network through which a User can log in or create an
        ...
        <li>
          <strong>Website</strong> refers to E-Modulus, accessible from{" "}
          {/* <a href="https://E-Modulus.com/">E-Modulus.com</a>. */}
        </li>
        <li>
      ...
      <ul className="points">
        <li>
          ...
          provide and maintain the Service, manage Your Account, or contact
          You..{" "}
        </li>
