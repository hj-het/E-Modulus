...
const BuyWebsiteSignUps = () => {
  ...
  const filteredBoxes = boxes.filter(
    (box) => box.type === "website" && box.subtype === "signups"
  );
  ...
  return (
    <div className="viewpage">
      <div className="section1">
        <h1>
          Buy Website <br />
          Signups <span className="label-red">Fast</span>
        </h1>
        <p>
          As the leading digital solutions provider, E-Modulus now offers
          website signups at unbeatable prices. Get fast, quality signups to
          boost your growth instantly!
        </p>
      </div>
