...
const BuyFbLikes = () => {
  ...
  const filteredBoxes = boxes.filter(
    (box) => box.type === "facebook" && box.subtype === "likes"
  );
  ...
  return (
    <div className="viewpage">
      <div className="section1">
        <h1>
          Buy Facebook <br />
          Likes <span className="label-red">Immediately</span>
        </h1>
        <p>
          E-Modulus offer you the most trustworthy and dependable service: buy
          Facebook followers. Every Facebook follower is real and active. Thanks
          to our top-quality followers, you can increase the exposure and
          reliability of your account.
        </p>
      </div>
