...
const BuyYouTubeAutoView = () => {
  ...
  const uniqueSubscriptionTypes = [
    ...new Set(
      boxes
        .filter((box) => box.subtype === "auto-likes") // Conditional filtering for "views"
  ...
  return (
    <div className="viewpage">
      <div className="section1">
        <h1>
          Buy YouTube <br />
          Auto Views <span className="label-red">Instantly</span>
        </h1>
        <p>
          Check out our services to boost engagement across your entire YouTube
          channel. Just sit back, relax, buy YouTube auto likes, and watch your
          videos gain traction effortlessly, helping you build credibility and
...
export default BuyYouTubeAutoView;
