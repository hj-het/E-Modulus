...
const BuyTwitterLikes = () => {
  ...
  const filteredBoxes = boxes.filter(
    (box) => box.type === "twitter" && box.subtype === "follow"
  );
  ...
  return (
    <div className="viewpage">
      <div className="section1">
        <h1>
          Buy Twitter <br />
          Followers <span className="label-red">Now</span>
        </h1>
        <p>
          The new name of Twitter, which Elon Musk bought in 2022, is now X.
          E-Modulus provides organic Twitter growth services & X growth service
          with high-quality followers - delivered naturally and fast. Check out
          our affordable packages to buy Twitter followers and take your account
          to new high levels.
        </p>
      </div>
