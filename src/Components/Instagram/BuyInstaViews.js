  ...
  return (
    <div className="viewpage">
      <div className="section1">
        <h1>
          Buy Instagram <br />
          Views <span className="label-red">Effortlessly</span>
        </h1>
        <p>
          Are you searching for the "Buy Instagram Views" service? If you say
          yes, then you are in the right spot! Thanks to E-Modulus's top-notch
          video views, you can be more visible on the Instagram Explore Page.
          Take this chance and enhance your view count with our reputable and
          reliable service.
        </p>
      </div>
